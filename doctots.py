...
class doctor_win:
    def __init__(self, root):
        ...
        # ==================doctor picture==============
        img2 = Image.open(r"C:\Users\asus\OneDrive\Pictures\Feedback\conceltant.jpg")
        ...
        head_fr4 = ctk.CTkFrame(self.root, fg_color="#303030", width=435, height=200)
        head_fr4.place(x=0, y=420)

        user = ctk.CTkLabel(head_fr4,
                            text="At MedExPart, our doctor consultation service \n"
                                 "connects you to expert medical advice anytime, \nany"
                                 "where. With access to certified professionals \n"
                                 "across specialties, we ensure that quality \n"
                                 "healthcare is only a click away."
                            ,
        ...
        self.Details_Table = ttk.Treeview(tableframeshow, columns=(
            "Location", "Contact_number", "Service_type", "Driver_name", "Service_Time", "Booking_history",
            "Driver_email", "Feed_Back"))
